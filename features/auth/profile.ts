...
export function parseUserProfile(uid: string, value: unknown, fallbackEmail = ""): UserProfile {
  ...
  return {
    ...
    customerTermsAcceptedAt: toDate(data.customerTermsAcceptedAt),
    customerTermsVersion: typeof data.customerTermsVersion === "string" ? data.customerTermsVersion : null,
