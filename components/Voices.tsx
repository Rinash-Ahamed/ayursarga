...
export default function Voices() {
  return <section id="partners" className="section partner-section"><div className="section-inner partner-panel">
    <div className="partner-copy"><RevealWords text="For Centres & Resorts" className="eyebrow" /><RevealLines as="h2" className="section-title" lines={["Good care deserves", "to be discovered."]} /><FadeUp as="p" className="section-intro partner-intro">Partner with Ayursarga to meet people already looking for the kind of trusted Ayurvedic experience you provide.</FadeUp><FadeUp><MagneticButton href="#contact" className="btn-magnetic btn-primary">Partner With Us</MagneticButton></FadeUp></div>
