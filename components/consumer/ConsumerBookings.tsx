...
export function ConsumerBookings() {
  ...
  return <PortalShell role="consumer" title="My bookings"><PortalFeedback error={error} empty={!error && !isLoading && items.length === 0 ? "You have no bookings yet. Find a hospital to request your first appointment." : undefined} /><PortalToast message={actionMessage} />
